...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Blue>Finn hub chào tất cả anh em<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Black>Hãy sử dụng Fluxus để có trải nghiệm tốt!!<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Tham gia discord để cập nhật thông tin mới nhất nhé<Color=/>"):Display()
    wait(.29)
